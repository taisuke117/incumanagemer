...
- Enable GitHub Pages for this repository and use `https://<user>.github.io/incumanager/` (recommended — the JSON auto-save is most reliable over https).
...
- このリポジトリで GitHub Pages を有効にして `https://<user>.github.io/incumanager/` を使う（**推奨**。https のほうが JSON 自動保存が確実です）。
